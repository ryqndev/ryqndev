    ...
    return (
        ...
        <article className="boba-watch--wrapper">
            ...
            <div className="description">
                ...
                April of 2019. Using a <span>React</span> / <span>SASS</span> /{' '}
                <span>Firebase</span> tech stack, I built the app from the
                ground up and designed the infrastructure currently in place to
                support high level production features such as <span>i18n</span>{' '}
            ...
            <div className="description light">
                <h3>
                    social media. <br /> for <span>boba</span>.
                </h3>
                <span>Boba Watch</span> allows users to <span>publish</span>{' '}
                their recorded drinks - posting them on the public feed as well
                as their personal profile. Users can <span>like</span> and{' '}
                <span>favorite</span> posts from other users, creating what is
                essentially a <span>social media platform based on boba</span>.
            </div>
        </article>
        // </ProjectWrapper>
    );
